...
function Writing() {
  ...
  return (
    <div style={{ padding: "2rem" }} className="pageMargin">
      ...
      >
        <Title>
          <i>Content Writing & Language Services</i>
        </Title>
        <Subtitle>
          <i>
            Tell your story with words that captivate, convert, and connect.
            From compelling copy to precise translations — we make every word
            work for you.
          </i>
        </Subtitle>
        <div
        ...
        >
          ...
          >
            ...
            >
              <div className={`${!isMobile ? "circleComp" : "circlComponent"}`}>
                {" "}
                <CircleComponent
              ...
              >
                ...
                {openPhysician && (
                  ...
                  >
                    ...
                    <StepSubtitle>
                      ...
                      conversion — we turn visibility into real value. Website &
                      Blog Writing
                    </StepSubtitle>
                    <Button
                      className="mt-auto"
                ...
                >
                  <StepTitle>Content Writing</StepTitle>
                  <StepSubtitle>
                    Words that inform, engage, and drive action - Our expert
                    content writers craft impactful, SEO-optimized content
                    tailored to your audience and brand voice.
                  </StepSubtitle>
                  <StepTitle>Language Services</StepTitle>
                  <StepSubtitle>
                    Bridge communication gaps with expert language solutions.
                  </StepSubtitle>
                  <Button
                    className="mt-auto"
                    style={{
