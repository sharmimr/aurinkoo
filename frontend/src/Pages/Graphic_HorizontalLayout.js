...
const HorizontalLayout = ({ onCircleClick, width_ = 800, height_ = 800, onShapeMouseOut, onShapeMouseOver }) => {
  ...
  useEffect(() => {
    if (d3Container.current) {
      ...
      const circleData = [
        ...
        { label: "API Management", icon: "icon2.png", content: "Content 2" },
        {
          label: "Data Analytics & AI",
          icon: "icon3.png",
          content: "Content 3",
        },
        { label: "QA & Testing", icon: "icon4.png", content: "Content 4" },
      ];
      ...
      circleData.forEach((data, i) => {
        ...
        circle.on('mouseover', function () {
          ...
          text.transition()
            .duration(500)
            .attr('font-size', '24px'); // Increase the font size
        ...
        circle.on('mouseout', function () {
          ...
          text.transition()
            .duration(500)
            .attr('font-size', '20px'); // Return the font size to original
