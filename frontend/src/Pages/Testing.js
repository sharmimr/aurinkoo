...
function Testing() {
  ...
  return (
    <div style={{ padding: "2rem" }} className="pageMargin">
      ...
      >
        <Title>
          <i>QA & Application Testing</i>
        </Title>
        <Subtitle>
          <i>
            From functionality to performance, we test it all. Deliver seamless
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <StepTitle>Application Testing</StepTitle>
                  <StepSubtitle>
                    Ensure flawless performance, security, and user experience.
                    Our end-to-end application testing services help identify
                    bugs, improve functionality, and deliver high-quality
